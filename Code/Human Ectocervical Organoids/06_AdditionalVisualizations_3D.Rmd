---
title: "Additional Visualizations for 3D conditions"
...
sel_comparisons = c("E-3D_Ecto_noE6E7_5d_p.i._vs_UI", "F-3D_Ecto_E6E7_5d_p.i._vs_UI","M_3D_Ecto_5dpi_E6E7_vs_UInoE6E7", "K_3D_Ecto_UI_E6E7_vs_noE6E7","L_3D_Ecto_5dpi_E6E7_vs_noE6E7")
...
write.table(mat_new, file=file.path(result_folder, "HM_3D_E2F_targets_clusters_and_genes.txt"), sep="\t", quote=F, row.names=T, col.names = NA)
...
write.table(mat_new, file=file.path(result_folder, "HM_3D_HALLMARK_TP53_clusters_and_genes.txt"), sep="\t", quote=F, row.names=T, col.names = NA)
...
write.table(mat_new, file=file.path(result_folder, "HM_3D_FISCHER_DIRECT_TP53_targets_clusters_and_genes.txt"), sep="\t", quote=F, row.names=T, col.names = NA)
...
write.table(mat_new, file=file.path(result_folder, "HM_3D_FISCHER_DREAM_targets_clusters_and_genes.txt"), sep="\t", quote=F, row.names=T, col.names = NA)
